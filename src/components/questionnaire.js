  ...
  pages: [
   {
    ...
    elements: [
     {
      type: "dropdown",
      name: "I would prefer to volunteer",
      choices: [
       "Once a week",
       "Once a month",
       "For one-off events"
     ...
     {
      type: "checkbox",
      name: "I have a (tick as many as apply)",
      choices: [
     ...
     {
      type: "checkbox",
      name: "In addition to English, I speak:",
      choices: [
       "Cantonese",
       "Mandarin",
       "Arabic",
     ...
     {
      type: "checkbox",
      name: "Which of these Volunteer Opportunities sound interesting to you? (Tick as many as you like)",
      choices: [
     ...
     {
      type: "checkbox",
      name: "Volunteering doesn’t always have to mean a regular weekly commitment. Community organisations frequently need help with one-off tasks that they don’t have the skills, or time, for. Do you have any of these skills? Tick as many as apply.",
      valueName: "Volunteering doesn’t always have to mean a regular weekly commitment  Community organisations frequently need help with one-off tasks that they don’t have the skills, or time, for  Do you have any of these skills? Tick as many as apply",
      choices: [
     ...
     {
      type: "checkbox",
      name: "So that we don’t bother you with unsuitable options, please tick any of these that apply to you:",
      choices: [
